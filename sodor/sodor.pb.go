...
func (x *TaskRelation) GetConditionType() string {
	if x != nil {
...
var file_sodor_sodor_proto_rawDesc = []byte{
	...
	0x22, 0x88, 0x01, 0x0a, 0x0c, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	...
	0x54, 0x61, 0x73, 0x6b, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x6f,
	...
	0x53, 0x4d, 0x5f, 0x43, 0x72, 0x6f, 0x6e, 0x74, 0x61, 0x62, 0x10, 0x01, 0x32, 0x2c, 0x0a, 0x0d,
	0x46, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x12, 0x1b, 0x0a,
	0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a, 0x6f, 0x62, 0x12, 0x04, 0x2e, 0x4a, 0x6f, 0x62,
	0x1a, 0x06, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x69,
...
var file_sodor_sodor_proto_goTypes = []interface{}{
	...
	(*Reply)(nil),            // 2: Reply
	(*RoutineSpec)(nil),      // 3: RoutineSpec
	(*Task)(nil),             // 4: Task
	(*Job)(nil),              // 5: Job
	(*TaskRelation)(nil),     // 6: TaskRelation
	(*AlertGroup)(nil),       // 7: AlertGroup
	(*AlertPluginParam)(nil), // 8: AlertPluginParam
	(*AlertPlugin)(nil),      // 9: AlertPlugin
	(*AlertHistory)(nil),     // 10: AlertHistory
}
var file_sodor_sodor_proto_depIdxs = []int32{
	1, // 0: Task.scheduler_mode:type_name -> SchedulerMode
	3, // 1: Task.routine_spec:type_name -> RoutineSpec
	4, // 2: Job.tasks:type_name -> Task
	6, // 3: Job.relations:type_name -> TaskRelation
	8, // 4: AlertPlugin.params:type_name -> AlertPluginParam
	5, // 5: FatController.CreateJob:input_type -> Job
	2, // 6: FatController.CreateJob:output_type -> Reply
