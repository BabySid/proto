...
type AlertInstances struct {
	...
	AlertInstances []*AlertInstance `protobuf:"bytes,1,rep,name=alert_instances,json=alertInstances,proto3" json:"alert_instances,omitempty"`
}
...
func (x *AlertInstances) GetAlertInstances() []*AlertInstance {
	if x != nil {
		return x.AlertInstances
	}
	return nil
}
...
func (x *AlertInstance) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *AlertInstance) GetCreateAt() int32 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
func (x *AlertInstance) GetUpdateAt() int32 {
	if x != nil {
		return x.UpdateAt
	}
	return 0
...
func (x *AlertInstance) GetGroupId() int32 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *AlertInstance) GetPluginName() string {
	if x != nil {
		return x.PluginName
	}
	return ""
...
func (x *AlertInstance) GetPluginValue() *structpb.Struct {
	if x != nil {
...
var file_sodor_sodor_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x49, 0x0a, 0x0e,
	0x41, 0x6c, 0x65, 0x72, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x37,
	0x0a, 0x0f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x5f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x49,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x0e, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x49, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x0d, 0x41, 0x6c, 0x65, 0x72,
...
var file_sodor_sodor_proto_goTypes = []interface{}{
	...
	(*AlertInstances)(nil),    // 33: AlertInstances
	(*AlertInstance)(nil),     // 34: AlertInstance
...
var file_sodor_sodor_proto_depIdxs = []int32{
	...
	34, // 26: AlertInstances.alert_instances:type_name -> AlertInstance
	35, // 27: AlertInstance.plugin_value:type_name -> google.protobuf.Struct
