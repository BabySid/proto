...
type AlertGroup struct {
	...
	UpdateAt       int32   `protobuf:"varint,3,opt,name=update_at,json=updateAt,proto3" json:"update_at,omitempty"`
	Name           string  `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`
	PluginInstance []int32 `protobuf:"varint,5,rep,packed,name=plugin_instance,json=pluginInstance,proto3" json:"plugin_instance,omitempty"`
}

func (x *AlertGroup) Reset() {
	*x = AlertGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sodor_sodor_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertGroup) Descriptor() ([]byte, []int) {
	return file_sodor_sodor_proto_rawDescGZIP(), []int{24}
}
...
func (x *AlertGroup) GetPluginInstance() []int32 {
	if x != nil {
...
func (x *AlertPluginInstances) Reset() {
	*x = AlertPluginInstances{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sodor_sodor_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertPluginInstances) Descriptor() ([]byte, []int) {
	return file_sodor_sodor_proto_rawDescGZIP(), []int{25}
}

func (x *AlertPluginInstances) GetAlertPluginInstances() []*AlertPluginInstance {
	if x != nil {
		return x.AlertPluginInstances
	}
	return nil
}
...
func (x *AlertPluginDingDing) Reset() {
	*x = AlertPluginDingDing{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sodor_sodor_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertPluginDingDing) Descriptor() ([]byte, []int) {
	return file_sodor_sodor_proto_rawDescGZIP(), []int{26}
}
...
type AlertPluginInstance struct {
	...
	//	*AlertPluginInstance_Dingding
	Plugin isAlertPluginInstance_Plugin `protobuf_oneof:"plugin"`
}

func (x *AlertPluginInstance) Reset() {
	*x = AlertPluginInstance{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sodor_sodor_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertPluginInstance) Descriptor() ([]byte, []int) {
	return file_sodor_sodor_proto_rawDescGZIP(), []int{27}
}
...
func (m *AlertPluginInstance) GetPlugin() isAlertPluginInstance_Plugin {
	if m != nil {
		return m.Plugin
	}
	return nil
...
func (x *AlertPluginInstance) GetDingding() *AlertPluginDingDing {
	if x, ok := x.GetPlugin().(*AlertPluginInstance_Dingding); ok {
		return x.Dingding
	}
	return nil
}

type isAlertPluginInstance_Plugin interface {
	isAlertPluginInstance_Plugin()
}

type AlertPluginInstance_Dingding struct {
	Dingding *AlertPluginDingDing `protobuf:"bytes,6,opt,name=dingding,proto3,oneof"`
}

func (*AlertPluginInstance_Dingding) isAlertPluginInstance_Plugin() {}
...
type AlertPluginInstanceHistories struct {
	...
	AlertPluginInstanceHistory []*AlertPluginInstanceHistory `protobuf:"bytes,1,rep,name=alert_plugin_instance_history,json=alertPluginInstanceHistory,proto3" json:"alert_plugin_instance_history,omitempty"`
}

func (x *AlertPluginInstanceHistories) Reset() {
	*x = AlertPluginInstanceHistories{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sodor_sodor_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AlertPluginInstanceHistories) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AlertPluginInstanceHistories) ProtoMessage() {}

func (x *AlertPluginInstanceHistories) ProtoReflect() protoreflect.Message {
	mi := &file_sodor_sodor_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *AlertPluginInstanceHistory) Reset() {
	*x = AlertPluginInstanceHistory{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sodor_sodor_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *AlertPluginInstanceHistory) ProtoReflect() protoreflect.Message {
	mi := &file_sodor_sodor_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*AlertPluginInstanceHistory) Descriptor() ([]byte, []int) {
	return file_sodor_sodor_proto_rawDescGZIP(), []int{29}
}
...
var file_sodor_sodor_proto_rawDesc = []byte{
	...
	0x41, 0x6c, 0x65, 0x72, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22,
	0x22, 0x0a, 0x10, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52, 0x65,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x26, 0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x65, 0x53,
	0x70, 0x65, 0x63, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x74, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x74, 0x53, 0x70, 0x65, 0x63, 0x22, 0x39, 0x0a, 0x04,
	0x48, 0x6f, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x09, 0x2e, 0x48, 0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0xe0, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b,
	...
	0x62, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49,
	0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2a, 0x0a, 0x0d, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67,
	0x5f, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x48,
	0x6f, 0x73, 0x74, 0x52, 0x0c, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x48, 0x6f, 0x73, 0x74,
	0x73, 0x12, 0x1d, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xb8, 0x02, 0x0a, 0x03, 0x4a,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x6f, 0x54, 0x61, 0x73, 0x6b, 0x22, 0xfb, 0x01,
	0x0a, 0x0b, 0x4a, 0x6f, 0x62, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x0e, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x69, 0x67, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x74, 0x5f, 0x6d, 0x6f, 0x62, 0x69, 0x6c,
	0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x61, 0x74, 0x4d, 0x6f, 0x62, 0x69,
	0x6c, 0x65, 0x73, 0x22, 0xd2, 0x01, 0x0a, 0x13, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x50, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	,
...
var file_sodor_sodor_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_sodor_sodor_proto_goTypes = []interface{}{
	...
	(AlertPluginName)(0),                 // 4: AlertPluginName
	(*JobReply)(nil),                     // 5: JobReply
	(*ThomasReply)(nil),                  // 6: ThomasReply
	(*AlertGroupReply)(nil),              // 7: AlertGroupReply
	(*AlertPluginReply)(nil),             // 8: AlertPluginReply
	...
	(*FatCtrlInfos)(nil),                 // 22: FatCtrlInfos
	(*ThomasInfos)(nil),                  // 23: ThomasInfos
	(*ThomasInfo)(nil),                   // 24: ThomasInfo
	(*ThomasInstances)(nil),              // 25: ThomasInstances
	(*ThomasInstance)(nil),               // 26: ThomasInstance
	(*ThomasMetrics)(nil),                // 27: ThomasMetrics
	(*AlertGroups)(nil),                  // 28: AlertGroups
	(*AlertGroup)(nil),                   // 29: AlertGroup
	(*AlertPluginInstances)(nil),         // 30: AlertPluginInstances
	(*AlertPluginDingDing)(nil),          // 31: AlertPluginDingDing
	(*AlertPluginInstance)(nil),          // 32: AlertPluginInstance
	(*AlertPluginInstanceHistories)(nil), // 33: AlertPluginInstanceHistories
	(*AlertPluginInstanceHistory)(nil),   // 34: AlertPluginInstanceHistory
...
var file_sodor_sodor_proto_depIdxs = []int32{
	...
	35, // 9: TaskInstance.output_vars:type_name -> google.protobuf.Struct
	...
	21, // 13: FatCtrlInfos.fat_ctrl_infos:type_name -> FatCtrlInfo
	24, // 14: ThomasInfos.thomas_infos:type_name -> ThomasInfo
	3,  // 15: ThomasInfo.thomas_type:type_name -> ThomasType
	35, // 16: ThomasInfo.latest_metrics:type_name -> google.protobuf.Struct
	26, // 17: ThomasInstances.thomas_instances:type_name -> ThomasInstance
	24, // 18: ThomasInstance.thomas:type_name -> ThomasInfo
	27, // 19: ThomasInstance.metrics:type_name -> ThomasMetrics
	35, // 20: ThomasMetrics.metrics:type_name -> google.protobuf.Struct
	29, // 21: AlertGroups.alert_groups:type_name -> AlertGroup
	32, // 22: AlertPluginInstances.alert_plugin_instances:type_name -> AlertPluginInstance
	31, // 23: AlertPluginInstance.dingding:type_name -> AlertPluginDingDing
	34, // 24: AlertPluginInstanceHistories.alert_plugin_instance_history:type_name -> AlertPluginInstanceHistory
...
func file_sodor_sodor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sodor_sodor_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sodor_sodor_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertPluginInstances); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sodor_sodor_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertPluginDingDing); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sodor_sodor_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertPluginInstance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sodor_sodor_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertPluginInstanceHistories); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sodor_sodor_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertPluginInstanceHistory); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_sodor_sodor_proto_msgTypes[27].OneofWrappers = []interface{}{
		(*AlertPluginInstance_Dingding)(nil),
	}
	type x struct{}
